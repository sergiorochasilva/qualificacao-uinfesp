...
A inserção de figuras é realizada normalmente através do comando \comando{begin\{figure\}}. Na \autoref{fig:logomarca_usp} é exibida a logomarca da UNIFESP com o pacote \textit{graphicx}. Já a \autoref{figura:exemplo_grafo} mostra um exemplo de grafo com o pacote \textit{xy}. Na \autoref{fig:animals} pode ser visto um exemplo de utilização de subfiguras. De acordo com as normas ABNT a lista de figuras é um elemento opcional do documento, para incluí-la é preciso inserir o comando \comando{incluidelistafiguras} antes do início do documento.
...
\begin{figure}[htb]
 \caption{Logomarca da UNIFESP}
 \label{fig:logomarca_usp}
 \centering
 \includegraphics[scale=0.23]{images/Unifesp_completa_policromia_RGB.png}
 \fdireta{usp:logo}
\end{figure}
